...
使用方法：聚宽 → 新建策略 → 粘贴 → 回测 2019-01-01 ~ 2026-06-01 → 运行 → 改TOP_N → 再跑

TOP_N 测试进度:
  TOP_N=5:  年化 3.12% | 夏普 -0.091 | 回撤 19.60% | 超额 -23.75% ← 跑输基准!
  TOP_N=10: 待跑
  TOP_N=15: 年化 10.05% | 夏普 0.395 | 回撤 23.93% | 盈亏比 1.51 ← v2.1基准
  TOP_N=20: 待跑
  TOP_N=30: 待跑
"""
